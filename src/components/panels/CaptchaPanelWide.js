...
function CaptchaPanelWide(props) {
    ...
    return(
        <div className="captcha_panel-wide">

            <span className="panel-header_text" style={{width:"15%"}}>{props.email}</span>
            <span className="panel-header_text" style={{width:"15%"}}>{statusText}</span>
            ...
            <div className="captcha_panel-bar">
                <div className="captcha_panel-progress" style={{width:`${scorePercent}`,backgroundColor:`${scoreColor}`}}></div>
            </div>
...
export default CaptchaPanelWide;